...
async def update_user_settings(query):
    ...
    if not ospath.exists(tpath):
        tpath = "https://graph.org/file/643cd05635d8ba1e4de32.png"
...
Examples:
1. <code>{escape('<b>@Softleech</b>')}</code> 
This will give output as:
<b>@Softleech</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>@Softleech</code>')}</code> 
This will give output as:
<code>@Softleech</code> <code>69MB.bin</code>.
